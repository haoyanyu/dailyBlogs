...
import { selectTodos, addTodo, toggleTodo } from "../../store/todos"
            ...
            todos.map((todo: any, index: number) => {
              return (
                <li key={todo.text} className={classnames(styles['todo-list_item-inner'], { [styles.selected]: todo.completed })}>
                  <div className={styles["selectable-tag-image-container"]} style={{color: 'rgb(255, 204, 0)'}} onClick={() => handleStatus(index)}>
